...
$sorgu2=$vt->prepare('SELECT *FROM partnerler WHERE id=?');
 ...
 ?>
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1><?php echo $projeler["baslik"] ?><span class="m_1">Partner Detayları.</span></h1>
		</div>
	</div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="message-box">
                        ...
                        <a href="partnerlerimiz.php" data-scroll class="btn btn-light btn-radius btn-brd grd1 effect-1">Partnerler Sayfası</a>
                    </div><!-- end messagebox -->
                </div><!-- end col -->
